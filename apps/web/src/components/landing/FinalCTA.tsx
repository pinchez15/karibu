...
export function FinalCTA() {
  ...
  return (
    <section id="apply" className="py-[92px]">
      <Container narrow>
        <Reveal>
          <div className="grid overflow-hidden rounded-3xl border border-line bg-white shadow-[0_24px_60px_rgba(11,20,82,0.08)] max-[920px]:grid-cols-1 min-[921px]:grid-cols-[1.1fr_1fr]">
            <div className="p-10">
              ...
              <h2 className="mt-3.5 text-[clamp(26px,2.8vw,34px)] font-semibold leading-[1.1] tracking-[-0.025em] text-ink">
            ...
            <div className="border-t border-line bg-[rgb(var(--kh-bg))] p-10 min-[921px]:border-l min-[921px]:border-t-0">
              {!submitted ? (
                <form onSubmit={handleSubmit} className="flex flex-col gap-3">
                  {(
                    [
                      ['facility', 'Facility name', 'Susunga HC III'],
                      ['district', 'District', 'Mityana'],
                      ['role', 'Your role', 'In-charge / Clinical officer'],
                      ['phone', 'Phone', '+256 7…'],
                    ] as const
                    ...
                    <label key={key} className="block">
                      ...
                      <input
                        ...
                        className="mt-1 w-full rounded-[10px] border border-line bg-white px-[13px] py-[11px] text-sm text-ink outline-none transition-[border-color,box-shadow] focus:border-cobalt focus:shadow-[0_0_0_4px_rgb(var(--kh-cobalt-soft))]"
                      />
                    </label>
                  ))}
                ...
                <div className="flex min-h-[280px] flex-col items-center justify-center text-center">
                  ...
                  <h3 className="text-xl font-semibold text-ink">Application sent</h3>
