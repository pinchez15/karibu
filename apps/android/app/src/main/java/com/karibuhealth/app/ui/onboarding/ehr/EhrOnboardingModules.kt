...
/**
 * EHR-native onboarding modules — step copy mirrors web `ehr-modules.ts`.
 * Manifest JSON still drives hub titles; this file is the training source of truth.
 */
data class EhrOnboardingStep(
    val id: String,
    val title: String,
    val body: String,
    val paper: String? = null,
    val tip: String? = null,
    val requiresMockAction: Boolean = false,
)

enum class EhrMockKind {
    Records,
    Vitals,
    Clinician,
    Lab,
...
data class EhrModuleDef(
    val id: String,
    val roleLabel: String,
    val title: String,
    val subtitle: String,
    val intro: String,
    val mockKind: EhrMockKind,
    val steps: List<EhrOnboardingStep>,
)
...
object EhrOnboardingModules {
    ...
    private val recordsRegister = EhrModuleDef(
        ...
        intro = "At the front desk you give every patient one identity in Karibu. Search first — most arrivals are returning. Only register when no match exists; saving creates today's visit automatically.",
        mockKind = EhrMockKind.Records,
        steps = listOf(
            EhrOnboardingStep(
                id = "open-patients",
                title = "Open Patients",
    ...
    private val nurseVitals = EhrModuleDef(
        id = "nurse-vitals",
        roleLabel = "Registered Nurse",
        title = "Record vitals",
        subtitle = "Capture vitals on the visit screen",
        intro = "Nurses record vitals on today's visit before the clinician documents. Every field is optional — capture only what you measured.",
        mockKind = EhrMockKind.Vitals,
        steps = listOf(
            EhrOnboardingStep(
                id = "open-worklist",
    ...
    private val clinicianNotePharmacy = EhrModuleDef(
        ...
        intro = "The Clinical Officer documents in structured sections on the visit screen. Order labs and send prescriptions while the note is still open.",
        mockKind = EhrMockKind.Clinician,
        steps = listOf(
            EhrOnboardingStep(
                id = "open-visit",
                title = "Open the visit",
    ...
    private val labResult = EhrModuleDef(
        id = "lab-result",
        roleLabel = "Lab Technician",
        title = "Record a lab result",
        subtitle = "Lab Today queue",
        intro = "Lab staff work the **Lab → Today** board. Start each test, enter the result, and save — clinicians see it on the visit chart.",
        mockKind = EhrMockKind.Lab,
        steps = listOf(
            EhrOnboardingStep(
                id = "open-lab",
    ...
    private val pharmacyDispense = EhrModuleDef(
        id = "pharmacy-dispense",
        roleLabel = "Dispenser / Pharmacy",
        title = "Dispense medicines",
        subtitle = "Pharmacy dispensing queue",
        intro = "When the clinician sends structured prescriptions, the visit appears under **Pharmacy → Dispensing → Waiting**.",
        mockKind = EhrMockKind.Pharmacy,
        steps = listOf(
            EhrOnboardingStep(
                id = "open-pharmacy",
                title = "Open Pharmacy",
    ...
    private val billingPayment = EhrModuleDef(
        id = "billing-payment",
        roleLabel = "Records / Front desk",
        title = "Record a payment",
        subtitle = "Billing without blocking care",
        intro = "Karibu separates payment from clinical closure. Open **Billing → Payments**, select a patient with a balance, and record cash or mobile money.",
        mockKind = EhrMockKind.Billing,
        steps = listOf(
            EhrOnboardingStep(
                id = "open-billing",
                title = "Open Payments",
