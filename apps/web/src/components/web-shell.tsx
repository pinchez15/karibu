...
const UNITS: UnitDef[] = [
  {
    ...
    label: 'OPD',
    icon: Stethoscope,
    basePaths: ['/dashboard/visits', '/dashboard/worklists', '/dashboard/orders', '/dashboard/consult', '/dashboard/review'],
    roles: CLINICAL,
    items: [
      ...
      { id: 'consult', label: 'Consult', href: '/dashboard/consult', icon: MessageSquare },
